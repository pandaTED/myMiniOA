...
var demoData = {
    ...
    menuList: [
        {"menu.name": "系统设置", "menu.prefix": "", "menu.icon": "FUNC20082.gif", "menu.url": "", "menu.description": ""},
        {
            "menu.name": "部门管理",
            "menu.prefix": "　　",
            "menu.icon": "menu_arrow_single.gif",
            "menu.url": "/DepartmentAction.do",
            "menu.description": ""
        },
        {
            "menu.name": "岗位管理",
        ...
        },
        {
            "menu.name": "网络硬盘",
            "menu.prefix": "",
            "menu.icon": "FUNC20056.gif",
            "menu.url": "/LanDiskAction.do",
            "menu.description": ""
        },
        {"menu.name": "审批流转", "menu.prefix": "", "menu.icon": "FUNC20057.gif", "menu.url": "", "menu.description": ""},
        {
            ...
            "menu.prefix": "　　",
            "menu.icon": "menu_arrow_single.gif",
            "menu.url": "/DocumentAction.do?method=list",
            "menu.description": ""
        },
        {
            "menu.name": "待我审批",
            "menu.prefix": "　　",
            "menu.icon": "menu_arrow_single.gif",
            "menu.url": "/DocumentAction.do?method=myTaskList",
            "menu.description": ""
        },
        {
            "menu.name": "表单模板管理",
            "menu.prefix": "　　",
            "menu.icon": "menu_arrow_single.gif",
            "menu.url": "/DocumentTemplateAction.do",
            "menu.description": ""
        },
        {
            "menu.name": "审批流程管理",
    ...
    messageList: [
        {
            "message.priority": "！",
            "message.title": "<b>您发送的※派车申请单-网络中心-管理员-0115被退文</b>",
            "message.sender": "系统",
            "message.recipient": "刘东风",
            "message.postTime": "2010-04-15 18:41"
        },
        {
            "message.priority": "",
            "message.title": "2010年公司年会举办活动征集",
            "message.sender": "系统",
            "message.recipient": "周顺利",
            "message.postTime": "2010-04-15 18:41"
        },
        {
            "message.priority": "！",
            "message.title": "销售部任务安排",
            "message.sender": "系统",
            "message.recipient": "王发财",
            "message.postTime": "2010-04-15 18:41"
        }
    ],
    messageList2: [
    ...
    documentTemplateList: [
        {
            ...
            "documentTemplate.name": "员工请假单",
            "documentTemplate.processName": "员工请假流程",
            "documentTemplate.description": ""
        },
        {
            "documentTemplate.id": 2,
            "documentTemplate.name": "费用报销单",
            "documentTemplate.processName": "费用报销流程",
            "documentTemplate.description": ""
        },
        {
            "documentTemplate.id": 3,
            "documentTemplate.name": "工作报告",
            "documentTemplate.processName": "工作报告流程",
            "documentTemplate.description": ""
        }
    ],
    systemMenuList: [
    ...
    processNodeList: [
        {
            "processNode.ordinal": 2,
            "processNode.name": "部门经理审批",
            "processNode.type": "审批",
            "processNode.description": ""
        },
        {
            "processNode.ordinal": 3,
            "processNode.name": "副总经理审批",
            "processNode.type": "审批",
            "processNode.description": ""
        },
    ...
    formList: [
        {
            "form.id": 1,
            "form.title": "设备采购单_管理员_2010-05-01 ",
            "form.applicant.name": "管理员",
            "form.applyTime": "2010-05-01 09:30",
            "form.status": "审批中"
        },
        {
            "form.id": 2,
            "form.title": "出车申请单_张雪_2010-05-12 ",
            "form.applicant.name": "张雪",
            "form.applyTime": "2010-05-12 09:30",
            "form.status": "未通过"
        },
        {
            "form.id": 3,
            "form.title": "请假申请单_张三_2010-07-23 ",
            "form.applicant.name": "张三",
            "form.applyTime": "2010-07-23 16:41",
            "form.status": "审批中"
        },
        {
            "form.id": 4,
            "form.title": "领款单_李明_2010-05-16 ",
            "form.applicant.name": "李明",
            "form.applyTime": "2010-05-16 09:30",
            "form.status": "已通过"
        }
    ],
    approveInfoList: [
        {
            "approveInfo.index": 2,
            "approveInfo.type": "审批",
            "approveInfo.approveTime": "2010-05-17 09:45",
            "approveInfo.approver": "李四",
            "approveInfo.approval": "同意",
            "approveInfo.comment": ""
        },
        {
            "approveInfo.index": 3,
    ...
    fileList: [
        {
            "file.name": "固定岗位.doc",
            "file.fileType.icon": "doc.gif",
            "file.size": "150B",
            "file.creationTime": "2010-5-24 09:56:33"
        },
        {
            "file.name": "条件流转.doc",
            "file.fileType.icon": "doc.gif",
    ...
    forumList: [
        {
            "forum.name": "JavaSE/JavaEE",
            "forum.description": "Java开发有关的讨论都过来发帖",
            "forum.topicCount": 56,
            "forum.articleCount": 107,
            "forum.lastTopic.title": "OA是什么？ ",
            "forum.lastTopic.author.name": "管理员",
            "forum.lastTopic.postTime": "2010-06-12 17:47"
        },
        {
            "forum.name": "新功能建议",
            "forum.description": "把好的想法、先进思想和理念都随时提出来，供产品修改时使用",
            "forum.topicCount": 56,
            "forum.articleCount": 107,
            "forum.lastTopic.title": "OA是什么？ ",
            "forum.lastTopic.author.name": "管理员",
        ...
        {
            "forum.name": "灌水专区",
            "forum.description": "大家可以尽情的来这里灌水",
            "forum.topicCount": 56,
            "forum.articleCount": 107,
            "forum.lastTopic.title": "OA是什么？ ",
            "forum.lastTopic.author.name": "管理员",
    ...
    replyList: [
        {
            "reply.title": "回复：新手发帖",
            "reply.content": "欢迎，欢迎，热烈欢迎！<img src='../script/fckeditor/editor/images/smiley/wangwang/15.gif'/>",
            "reply.floor": "1",
            "reply.faceIcon": "2"
        },
        ...
        {
            "reply.title": "回复：新手发帖",
            "reply.content": "<img src='../script/fckeditor/editor/images/smiley/wangwang/11.gif'/>",
            "reply.floor": "3",
            "reply.faceIcon": "3"
        }
    ],
